...
class WriteCommentTextField extends StatelessWidget {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          hintStyle: TextStyle(color: const Color(0xff9F9F9F),fontFamily: "Raleway",fontSize: 12.sp,fontWeight: FontWeight.w500),
